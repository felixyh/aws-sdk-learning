...
module "centos-server-linuxvm" {
  ...
  vmrp      = "Felix-Cluster/Resources/SRELab"
  network = {
    "VM Network" = ["192.168.22.61", "192.168.22.62", "192.168.22.63"] # To use DHCP create Empty list ["",""]; You can also use a CIDR annotation;
  }
